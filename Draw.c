...
{
    //bottom
    lineRGBA(s,101+x*21,   45+y*21,  119+x*21,   45+y*21,54,54,54,255);
    lineRGBA(s,101+x*21,   45+y*21-1,119+x*21-1, 45+y*21-1,54,54,54,255);
    lineRGBA(s,101+x*21,   45+y*21-2,119+x*21-2, 45+y*21-2,54,54,54,255);
    //right side
    lineRGBA(s,101+x*21+18,26+y*21,  101+x*21+18,45+y*21-1,85,85,85,255);
    lineRGBA(s,101+x*21+17,26+y*21,  101+x*21+17,45+y*21-2,85,85,85,255);
    lineRGBA(s,101+x*21+16,26+y*21,  101+x*21+16,45+y*21-3,85,85,85,255);
    //left side
    lineRGBA(s,101+x*21,   26+y*21,  101+x*21,   45+y*21-1,205,205,205,255);
    lineRGBA(s,101+x*21+1, 26+y*21+1,101+x*21+1, 45+y*21-2,205,205,205,255);
    lineRGBA(s,101+x*21+2, 26+y*21+2,101+x*21+2, 45+y*21-3,205,205,205,255);
    //top
    lineRGBA(s,101+x*21+1, 26+y*21,  119+x*21,   26+y*21,234,234,234,255);
    lineRGBA(s,101+x*21+2, 26+y*21+1,119+x*21-1, 26+y*21+1,234,234,234,255);
    lineRGBA(s,101+x*21+3, 26+y*21+2,119+x*21-2, 26+y*21+2,234,234,234,255);
}
            ...
            for(g = 0; g < sizex; g++)
                {
                    if(t[i][g] == 1 || t[i][g] == 2)
                    {
                        if(cfield[i][g] == 'I')
                            {
                                boxRGBA(s,101+ g*21,26+i*21,119 +g*21,45+ i*21,255,255,0,255);
                            }
                        else if(cfield[i][g] == 'A')
                            {
                                boxRGBA(s,101+ g*21,26+i*21,119 +g*21,45+ i*21,153,0,153,255);
                            }
                        else if(cfield[i][g] == 'O'){boxRGBA(s,101+ g*21,26+i*21,119 +g*21,45+ i*21,255,0,0,255);}
                        else if(cfield[i][g] == 'L'|| cfield[i][g] == 'R'){boxRGBA(s,101+ g*21,26+i*21,119 +g*21,45+ i*21,0,0,255,255);}
                        else if(cfield[i][g] == 'Z'|| cfield[i][g] == 'S'){boxRGBA(s,101+ g*21,26+i*21,119 +g*21,45+ i*21,0,255,0,255);}
                        else{boxRGBA(s,101+ g*21,26+i*21,119 +g*21,45+ i*21,0,0,255,255);}
                        dframe(s,g,i);
                    }
                    else if(t[i][g] == 2)
                    {
                    ...
                    {
                        boxRGBA(s,101 +g*21,26 +i*21,119 +g*21,45 +i*21,128,128,128,255);
                    }
                    else
                    {
...
void dnext(SDL_Surface *s,obj nxt)
{
    ...
    {
    case 'I':
        boxRGBA(s,321,172,341,192,255,255,0,255);
        boxRGBA(s,342,172,362,192,255,255,0,255);
        boxRGBA(s,363,172,383,192,255,255,0,255);
        boxRGBA(s,384,172,404,192,255,255,0,255);
        break;
    case 'R':
    ...
    case 'L':
        ...
        break;
    case 'A':
        boxRGBA(s,321,172,341,192,153,0,153,255);
        boxRGBA(s,342,172,362,192,153,0,153,255);
        boxRGBA(s,363,172,383,192,153,0,153,255);
        boxRGBA(s,342,151,362,171,153,0,153,255);
        break;
    case 'O':
        boxRGBA(s,321,172,341,192,255,0,0,255);
        boxRGBA(s,342,172,362,192,255,0,0,255);
        boxRGBA(s,321,151,341,171,255,0,0,255);
        boxRGBA(s,342,151,362,171,255,0,0,255);
        break;
    case 'S':
        boxRGBA(s,363,151,383,171,0,255,0,255);
        boxRGBA(s,342,172,362,192,0,255,0,255);
        boxRGBA(s,363,172,383,192,0,255,0,255);
        boxRGBA(s,384,151,404,171,0,255,0,255);
        break;
    case 'Z':
        boxRGBA(s,321,151,341,171,0,255,0,255);
        boxRGBA(s,342,172,362,192,0,255,0,255);
        boxRGBA(s,363,172,383,192,0,255,0,255);
        boxRGBA(s,342,151,362,171,0,255,0,255);
        break;
    }
}
